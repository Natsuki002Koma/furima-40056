...
RSpec.describe Item, type: :model do
  ...
  describe '商品出品' do
    ...
    context '商品出品できない場合' do
      ...
      it 'priceが半角数字で入力されていない場合は登録できない' do
        @item.price = '５００'
        @item.valid?
